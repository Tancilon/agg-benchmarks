...
const handleDownload = () => {
  emit('download', {
    ...
    options: {
      includePDF: downloadOptions.value.includePDF,
      includeCSV: downloadOptions.value.includeCSV,
      selectedAlgorithms: [props.algorithmInfo.name],
      selectedDatasets: downloadOptions.value.selectedDatasets,
      selectedKValues: isAtKMetric.value ? downloadOptions.value.selectedKValues : [],
      isAtK: isAtKMetric.value
    }
  })
}
</script>
          ...
          <div class="px-8 py-6 space-y-8">
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-2 gap-4">
                <label class="relative flex items-center p-4 rounded-xl border border-gray-200 hover:border-gray-300 transition-colors cursor-pointer group">
                  <input type="checkbox" v-model="downloadOptions.includePDF" class="sr-only peer">
                  <div class="w-5 h-5 rounded-lg border-2 border-gray-300 
                              peer-checked:border-green-500 peer-checked:bg-green-500 
                              flex items-center justify-center transition-all">
                    <svg v-if="downloadOptions.includePDF" 
                  ...
                  <span class="ml-3 text-sm text-gray-600 group-hover:text-gray-900">PDF Chart</span>
                </label>
                <label class="relative flex items-center p-4 rounded-xl border border-gray-200 hover:border-gray-300 transition-colors cursor-pointer group">
                  <input type="checkbox" v-model="downloadOptions.includeCSV" class="sr-only peer">
                  <div class="w-5 h-5 rounded-lg border-2 border-gray-300 
                              peer-checked:border-green-500 peer-checked:bg-green-500 
                              flex items-center justify-center transition-all">
                    <svg v-if="downloadOptions.includeCSV" 
                         class="w-3.5 h-3.5 text-white stroke-[3]" 
                         viewBox="0 0 24 24" 
                         fill="none" 
                         stroke="currentColor">
                  ...
                  <span class="ml-3 text-sm text-gray-600 group-hover:text-gray-900">CSV Data</span>
                </label>
              </div>
            </div>
          ...
          <div class="flex justify-end gap-3">
            ...
            <button
              ...
              :disabled="
                ...
                (!downloadOptions.includePDF && !downloadOptions.includeCSV)
              "
            >
